...
const Header: React.FC = () => {
  ...
  const handleMobileMenuClick = () => {
    // In a real application, this would show the mobile menu
    console.log('显示移动端菜单');
  };

  const handleLanguageSwitch = () => {
    // In a real application, this would show language selection menu
    console.log('显示语言选择菜单');
  };
      ...
      <header id="main-header" className="bg-white shadow-sm fixed top-0 left-0 right-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav id="main-nav" className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/collection-my" id="user-profile" className="flex items-center justify-center w-8 h-8 rounded-full bg-primary text-white">
