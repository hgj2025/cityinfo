...
const Header: React.FC = () => {
  ...
  const handleSearch = () => {
    if (searchQuery.trim()) {
      navigate(`/search-result?keyword=${encodeURIComponent(searchQuery.trim())}`);
    }
  };
      ...
      <header id="main-header" className="bg-white shadow-sm fixed top-0 left-0 right-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav id="main-nav" className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/collection-my" className={`${styles.navLink} active text-primary font-medium py-1`}>我的收藏</Link>
