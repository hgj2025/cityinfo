      ...
      <header id="main-header" className="bg-white shadow-sm fixed top-0 left-0 right-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav id="main-nav" className="hidden md:flex items-center space-x-6">
            <Link to="/home" className={`${styles['nav-link']} text-text-secondary hover:text-primary py-1`}>首页</Link>
            <Link to="/map-view" className={`${styles['nav-link']} text-text-secondary hover:text-primary py-1`}>地图浏览</Link>
            <Link to="/collection-my" className={`${styles['nav-link']} text-text-secondary hover:text-primary py-1`}>我的收藏</Link>
